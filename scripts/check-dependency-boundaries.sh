...
allowed_dependencies = {
    "gridthorn": {"gridthorn_app", "gridthorn_assets", "gridthorn_audio", "gridthorn_collision", "gridthorn_input", "gridthorn_render", "gridthorn_simulation", "gridthorn_world"},
    ...
    "gridthorn_render": {"gridthorn_assets"},
