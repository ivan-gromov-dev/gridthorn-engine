...
| ---------------------- | ---------------------------------------------------------- | ------------------------------------------------------------- |
| `gridthorn`            | Public SDK facade and curated prelude                      | `gridthorn_app`, `gridthorn_assets`, `gridthorn_audio`, `gridthorn_input`, `gridthorn_render`, `gridthorn_simulation`, `gridthorn_world` |
