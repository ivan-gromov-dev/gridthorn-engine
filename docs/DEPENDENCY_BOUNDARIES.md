...
| ---------------------- | ---------------------------------------------------------- | ------------------------------------------------------------- |
| `gridthorn`            | Public SDK facade and curated prelude                      | `gridthorn_app`, `gridthorn_assets`, `gridthorn_audio`, `gridthorn_collision`, `gridthorn_input`, `gridthorn_render`, `gridthorn_simulation`, `gridthorn_world` |
...
| `gridthorn_assets`     | Provisional image decoding and engine-owned asset data      | None                                                          |
